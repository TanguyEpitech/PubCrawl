...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Noto+Serif+Display&family=Pacifico&family=Raleway:ital,wght@1,600&family=Space+Mono&display=swap" rel="stylesheet">
...
<x-application-logo class="w-20 h-20 fill-current text-gray-500" />
        ...
        <div class="relative flex items-top justify-center  bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0" style="margin-bottom: 50px">
            @if (Route::has('login'))
...
<div class="container" >
    ...
    <h1 class="text-left ml-5">Nouveautées</h1>

    <div class="row">

        @foreach($all as $annonce)

            <div class="card shadow-md m-5 p-5 col-3" style="width: 18rem;">
